...
public class PlanarRegionDataImporterVisualizer
{
   private File defaultFile = null;

   public PlanarRegionDataImporterVisualizer(Stage primaryStage)
   {
   ...
   {
      ApplicationRunner.runApplication(PlanarRegionDataImporterVisualizer::new);
   }
}
