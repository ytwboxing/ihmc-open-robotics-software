...
public class BipedCoMTrajectoryPlannerVisualizer
{
   ...
   private static final int numberOfWalkingSteps = 18;
   ...
   private static final double simDt = 2e-2;
   ...
   public BipedCoMTrajectoryPlannerVisualizer(StepGetter stepGetter)
   {
      ...
      stopwatch = new ExecutionTimer("timer", 0.0, registry);
   ...
   static List<BipedTimedStep> createBigStepDown(SideDependentList<MovingReferenceFrame> soleFrames, Graphics3DObject worldGraphics)
   {
      List<BipedTimedStep> steps = new ArrayList<>();
      ...
      worldGraphics.identity();
      worldGraphics.translate(0.4, 0.0, 0.0);
      worldGraphics.addCube(0.5, 1.0, 0.4, YoAppearance.Gray());

      BipedTimedStep step1 = new BipedTimedStep();
      step1.getTimeInterval().setInterval(stepStartTime, stepStartTime + swingDuration);
      step1.setRobotSide(RobotSide.LEFT);
      step1.setGoalPose(new FramePoint3D(worldFrame, 0.3, stanceWidth / 2.0, 0.4), new FrameQuaternion());
      ...
      step2.getTimeInterval().setInterval(stepStartTime, stepStartTime + swingDuration);
      step2.setRobotSide(RobotSide.RIGHT);
      step2.setGoalPose(new FramePoint3D(worldFrame, 0.5, -stanceWidth / 2.0, 0.4), new FrameQuaternion());
      ...
      step3.getTimeInterval().setInterval(stepStartTime, stepStartTime + swingDuration);
      step3.setRobotSide(RobotSide.LEFT);
      step3.setGoalPose(new FramePoint3D(worldFrame, 0.8, stanceWidth / 2.0, 0.0), new FrameQuaternion());
      ...
      step4.getTimeInterval().setInterval(stepStartTime, stepStartTime + swingDuration);
      step4.setRobotSide(RobotSide.RIGHT);
      step4.setGoalPose(new FramePoint3D(worldFrame, 0.8, -stanceWidth / 2.0, 0.0), new FrameQuaternion());
