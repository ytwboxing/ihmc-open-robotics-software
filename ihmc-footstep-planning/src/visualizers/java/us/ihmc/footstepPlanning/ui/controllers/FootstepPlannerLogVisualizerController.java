...
public class FootstepPlannerLogVisualizerController
{
   ...
   private class TableColumnHolder
   {
      ...
      private final TableColumn<ChildStepProperty, String> deltaInsideColumn = new TableColumn<>("Δ Inside");
   ...
   public class ChildStepProperty
   {
      ...
      {
         return doubleFormat.format(edgeData.getAchievedWiggleInsideDelta());
      }
