...
buildscript {
   ...
   dependencies {
      classpath("us.ihmc:ros2-msg-to-pubsub-generator:0.14.2")
   }
}
...
mainDependencies {
   ...
   api("us.ihmc:ihmc-pub-sub:0.10.3")
   api("us.ihmc:ros2-common-interfaces:0.14.2")
...
generatorDependencies {
   api("us.ihmc:ihmc-commons:0.26.6")
   api("us.ihmc:ros2-msg-to-pubsub-generator:0.14.2")
}
