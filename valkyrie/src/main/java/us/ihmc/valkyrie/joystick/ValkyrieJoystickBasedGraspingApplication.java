...
public class ValkyrieJoystickBasedGraspingApplication
{
   ...
   public ValkyrieJoystickBasedGraspingApplication(Stage primaryStage, Parameters parameters) throws Exception
   {
   ...
   public static void main(String[] args)
   {
      ...
      {
         private ValkyrieJoystickBasedGraspingApplication app;

         @Override
         public void start(Stage primaryStage) throws Exception
         {
            app = new ValkyrieJoystickBasedGraspingApplication(primaryStage, new ParametersImpl(args));
         }
