...
public class SimpleHumanoidControllerFactory implements CloseableAndDisposable
{
   ...
   public SimpleHumanoidControllerFactory(ContactableBodiesFactory<RobotSide> contactableBodiesFactory, SideDependentList<String> footForceSensorNames,
                                             ...
                                             WalkingControllerParameters walkingControllerParameters, ICPWithTimeFreezingPlannerParameters icpPlannerParameters)
   {
      ...
      managerFactory = new SimpleControlManagerFactory(registry);
