...
public class SimpleSphereJumpVisualizer
{
   ...
   private final HashMap<SimpleSphereControllerInterface, Vector3DReadOnly> shift = new HashMap<>();

   public SimpleSphereJumpVisualizer()
   {
      List<Robot> robots = new ArrayList<>();
      YoGraphicsListRegistry yoGraphicsListRegistry1, yoGraphicsListRegistry2;
      SimplePusherController pushController1, pushController2;

      if (include1)
      {
         Vector3D initialPosition1 = new Vector3D(0.0, 0.0, desiredHeight);
         yoGraphicsListRegistry1 = new YoGraphicsListRegistry();
         SimpleSphereRobot sphereRobot1 = new SimpleSphereRobot("SphereRobot1", gravity, controlDT, desiredHeight, yoGraphicsListRegistry1);
         ...
         controller1 = new SimpleBasicSphereController(sphereRobot1, dcmPlan, yoGraphicsListRegistry1);
      ...
      if (include2)
      {
         ...
         SimpleSphereRobot sphereRobot2 = new SimpleSphereRobot("SphereRobot2", gravity, controlDT, desiredHeight, yoGraphicsListRegistry2);
         ...
         controller2 = new SimpleLQRSphereController(sphereRobot2, dcmPlan, yoGraphicsListRegistry2);
   ...
   {
      SimpleSphereJumpVisualizer simulation = new SimpleSphereJumpVisualizer();
