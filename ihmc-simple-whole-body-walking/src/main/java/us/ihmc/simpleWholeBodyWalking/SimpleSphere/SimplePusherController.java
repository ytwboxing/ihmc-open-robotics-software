...
public class SimplePusherController implements RobotController
{
   ...
   public SimplePusherController(Robot pushableRobot, Joint joint, Vector3DReadOnly forcePointOffset, double visualScale)
   {
